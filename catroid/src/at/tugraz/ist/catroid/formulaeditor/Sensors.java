...
public enum Sensors {
	X_ACCELERATION_("X_ACCELERATION_"), Y_ACCELERATION_("Y_ACCELERATION_"), Z_ACCELERATION_("Z_ACCELERATION_"), AZIMUTH_ORIENTATION_(
			"AZIMUTH_ORIENTATION_"), PITCH_ORIENTATION_("PITCH_ORIENTATION_"), ROLL_ORIENTATION_("ROLL_ORIENTATION_"), LOOK_X_(
			"LOOK_X_"), LOOK_Y_("LOOK_Y_"), LOOK_GHOSTEFFECT_("LOOK_GHOSTEFFECT_"), LOOK_BRIGHTNESS_("LOOK_BRIGHTNESS_"), LOOK_SIZE_(
